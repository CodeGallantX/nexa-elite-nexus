-- Update can_redeem_giveaway function to use 2 minute cooldown
...
DECLARE
  ...
  v_cooldown_seconds INTEGER := 120; -- 2 minutes cooldown
...
-- Update redeem_giveaway_code function to use 2 minute cooldown
