              ...
              {filteredLayouts.map((layout) => (
                <TableRow key={layout.id} className="border-gray-700">
                  <TableCell className="text-white">
                    <div>
                      <div className="font-medium">{layout.profiles.status === 'beta' ? 'Ɲ・乃' : 'Ɲ・乂'}{layout.profiles.ign}</div>
                            ...
                            <DialogContent className="max-w-4xl">
                              <DialogHeader>
                                <DialogTitle className="text-white">
                                  {layout.weapon_name} - {layout.profiles.status === 'beta' ? 'Ɲ・乃' : 'Ɲ・乂'}{layout.profiles.ign}
                                </DialogTitle>
                              </DialogHeader>
